...
import com.respect.learn.catalogservice.service.ProductServiceV2;
...
public class ProductController {
	...
	public void create(@RequestBody Product resource) {
	...
	public void update(@PathVariable("id") String name, @RequestBody Product resource) {
